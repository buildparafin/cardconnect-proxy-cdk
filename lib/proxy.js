...
class Proxy extends core.Construct {
  ...
  createResourcePolicy(ipWhitelist) {
  ...
  getAuthorizer(merchidWhitelist) {
    ...
    let basicAuth = new aws_lambda.Function(
      this,
      "basicAuthLambdaRestrictMerchIds",
      {
        runtime: aws_lambda.Runtime.NODEJS_12_X,
        code: new aws_lambda.AssetCode(join(__dirname, "lambdas")),
    ...
    return new apiGateway.RequestAuthorizer(
      ...
      "requestAuthRestrictMerchIds",
      {
        ...
        resultsCacheTtl: core.Duration.minutes(0),
      }
    );
  }
}
